...
**Quantum Research**
* [Natural Sciences](https://github.com/deltorobarba/science/blob/main/science.ipynb) 🍃🎨 Notes on Chemistry, Biology, Physics and Mathematics
...
* [IBM Quantum](https://github.com/deltorobarba/science/blob/main/ibm.ipynb) Create unequal superposition with rotation gates $R_y(\frac{\pi}{3})$ (Qiskit)
