...
* [Black Hole Physics](https://github.com/deltorobarba/science/blob/main/blackhole.ipynb) 🕳️ OTOC and Light Cone of Information Scrambling $C(t) = \langle [\hat{W}(t), \hat{V}(0)]^\dagger (\hat{W}(t), \hat{V}(0)] \rangle$ 
