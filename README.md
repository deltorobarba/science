...
[Google Scholar](https://scholar.google.com/citations?hl=en&user=fddyK-wAAAAJ) $\cdot$ [LinkedIn](https://www.linkedin.com/in/deltorobarba/) $\cdot$ [Medium](https://medium.com/@deltorobarba)
...
* [Quantum Evolution](https://github.com/deltorobarba/science/blob/main/schroedinger.ipynb) 🧬 Simulation with Time-Dependent Schrödinger $|\psi(t)\rangle = e^{-iHt} |\psi(0)\rangle$ (Trotter, LCU, Qubitization)
* [Quantum Chaos](https://github.com/deltorobarba/science/blob/main/otoc.ipynb) 🕳️ Scrambling of information in quantum dynamics $C(t) = \langle [\hat{W}(t), \hat{V}(0)]^\dagger (\hat{W}(t), \hat{V}(0)] (OTOC)
  \rangle$
