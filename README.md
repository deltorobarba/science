...
* [Quantum Chaos](https://github.com/deltorobarba/science/blob/main/otoc.ipynb) 🕳️ (OTOC) Scrambling of information in quantum dynamics $C(t) = \langle [\hat{W}(t), \hat{V}(0)]^\dagger (\hat{W}(t), \hat{V}(0)]
  \rangle$
