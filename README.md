...
* [Quantum Chaos](https://github.com/deltorobarba/science/blob/main/otoc.ipynb) 🕳️ Scrambling of information in quantum dynamics (OTOC) $C(t) = \langle [\hat{W}(t), \hat{V}(0)]^\dagger (\hat{W}(t), \hat{V}(0)]
  \rangle$
